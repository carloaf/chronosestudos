    ...
    <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-5">
                ...
                <p class="text-3xl font-bold text-indigo-600">{{ $dueToday->count() }}</p>
            </div>
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-5">
                <p class="text-sm text-slate-500 mb-1">Data</p>
                <p class="text-lg font-semibold text-slate-800">{{ \Carbon\Carbon::parse($today)->format('d/m/Y') }}</p>
            </div>
        </div>
        ...
        @if($dueToday->isEmpty())
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-12 text-center">
                <svg class="w-16 h-16 text-emerald-200 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                <h2 class="text-xl font-semibold text-slate-700 mb-2">Meta do dia concluída! 🎉</h2>
                <p class="text-slate-500">Nenhum tópico para revisar hoje. Aproveite o tempo livre!</p>
            </div>
        @else
            <div class="space-y-3">
