<x-guest-layout>
    <div class="text-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">⏳ ChronosEstudos</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Crie sua conta gratuita</p>
    </div>
